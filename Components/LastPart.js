        ...
        <div className="lg:m-48">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 justify-between ">
                <div className=''>
                    ...
                    <div className="relative px-3 py-1 lg:bottom-80 lg:left-6" >
                        <Image src={img2} className='w-10 h-10 rounded-full' ></Image>
                    </div>

                    <div className="relative flex w-32 h-14 bg-white py-1 lg:bottom-32  rounded " style={{ left: '-10%' }}>
                    ...
                    <div className="relative px-3 py-1 bottom-36 lg:bottom-2/3" style={{ left: '65%' }}>
